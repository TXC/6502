...
namespace Processor
{
    ...
    public class Processor
    {
        ...
        /// <summary>
        /// The break flag is not an actual flag implemented in a register, and rather
        ...
        /// </summary>
        public bool BreakFlag { get
            {
                return (PeekStack() & 0x10) != 0;
            }
            private set { }
        }
        /// <summary>
        ...
        private void SetDisassembly()
        {
            ...
            {
                HighAddress = address2.HasValue
                                ? address2.Value.ToString("X").PadLeft(2, '0')
                                : string.Empty,
                LowAddress = address1.HasValue
        ...
        /// <summary>
        /// The bit operation, does an AND comparison between a value in memory and the accumulator
        /// </summary>
