namespace Processor.UnitTests
{
    ...
    public class ProcessorTests
    {
        ...
        public void BRK_Program_Counter_Set_To_Address_At_Break_Vector_Address()
        {
            ...
            //Assert.That(processor.BreakFlag, Is.EqualTo(true));
        }
        ...
        public void PLA_Accumulator_Has_Correct_Value()
        {
            ...
            //Accounting for the Offest in memory
            Assert.That(processor.Accumulator, Is.EqualTo(0x03));
            //Assert.That(processor.BreakFlag, Is.EqualTo(false));
        }
        ...
        {
            var processor = new Processor();
            var loadOperation = transferFrom switch
            {
                RegisterMode.Accumulator => (byte)0xA9,
                RegisterMode.XRegister => (byte)0xA2,
                _ => (byte)0xA0,
            };
        ...
        public void ZeroPageX_Mode_Accumulator_Has_Correct_Result(byte operation, byte accumulatorInitialValue, byte valueToTest, byte expectedValue)
        {
            ...
            //Just remember that my value's for the STX and ADC were added to the end of the byte array.
            //In a real program this would be invalid, as an opcode would be next and 0x03 would be somewhere else
        ...
        public void NumberOfCyclesRemaining_Correct_After_Operations_That_Do_Not_Wrap(byte operation, int numberOfCyclesUsed)
        {
            ...
            Assert.That(
                startingNumberOfCycles + numberOfCyclesUsed,
                Is.EqualTo(processor.GetCycleCount())
            );
