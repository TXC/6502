    ...
    public class FunctionalProcessorTests
    {
        ...
        public void Cycle_Test()
        {
            ...
            while (true)
            {
                ...
                Assert.That(
                    CycleTestDataResults[numberofLoops].ProgramCounter,
                    Is.EqualTo(processor.ProgramCounter),
                    string.Format(
                        "Step {0} PC: {1}",
                        numberofLoops,
                ...
                Assert.That(
                    CycleTestDataResults[numberofLoops].CycleCount,
            ...
            Assert.That(Int32.Parse("1140"), Is.EqualTo(processor.GetCycleCount()));
